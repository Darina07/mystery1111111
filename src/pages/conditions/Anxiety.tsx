...
import { Phone, Brain, Heart, Wind, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Тревожност",
  subtitle: "Професионална помощ при тревожни състояния",
  ...
  whatIs: {
    ...
    content: "Тревожността е естествена реакция на стрес, но когато стане прекомерна или постоянна, тя може да попречи на ежедневния живот. Симптомите включват постоянно безпокойство, напрежение, затруднена концентрация, нарушения на съня и физически симптоми като учестено сърцебиене или задъхване."
  },
  howWeHelp: [
    { icon: Brain, title: "Когнитивни техники", description: "Разпознаване и промяна на тревожните мисли." },
    { icon: Wind, title: "Релаксационни методи", description: "Дихателни упражнения и техники за успокояване." },
    { icon: Heart, title: "Емоционална регулация", description: "Научаване да управлявате емоционалните реакции." },
    { icon: Shield, title: "Експозиционна терапия", description: "Постепенно преодоляване на избягващото поведение." }
  ],
  benefits: ["Намаляване на тревожните симптоми", "По-добър сън и релаксация", "Увереност в стресови ситуации", "Подобрено качество на живот", "Дългосрочни стратегии за справяне"]
};
