...
const conditionData = {
  title: "Липса на интимност",
  subtitle: "Семейно консултиране",
  description: "Възстановяване на емоционалната и физическа близост във вашата връзка.",
  ...
  whatIs: {
    title: "Какво е липсата на интимност?",
    content: `Липсата на интимност е постепенно отдалечаване между партньорите, което засяга както емоционалната, така и физическата близост. Тя може да се прояви като чувство за самота дори когато сте заедно.

Как се проявява:
• Рядък или липсващ физически контакт
• Повърхностни разговори без дълбочина
• Чувство за отчуждение от партньора
• Липса на споделени моменти и преживявания
• Усещане за "съквартиранти" вместо партньори
• Намален или липсващ интерес към сексуален живот`,
  },
  howWeHelp: [
    {
      icon: Heart,
      title: "Емоционална връзка",
      description: "Работим върху възстановяване на емоционалната близост и разбирането."
    },
    {
      icon: MessageCircle,
      title: "Дълбоки разговори",
      description: "Учим партньорите да водят смислени и свързващи разговори."
    },
    {
      icon: Shield,
      title: "Безопасност във връзката",
      description: "Изграждаме чувство за сигурност и приемане между партньорите."
    },
    {
      icon: Users,
      title: "Физическа близост",
      description: "Постепенно възстановяваме комфорта с физически контакт и интимност."
    },
  ],
  benefits: [
    "По-дълбока емоционална връзка",
    "Възобновена физическа близост",
    "Чувство за разбиране и приемане",
    "Повече качествено време заедно",
    "По-удовлетворяваща връзка",
    "Ново откритие на партньора",
  ],
};

const LackOfIntimacy = () => {
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Липса на{" "}<span className="gradient-text">интимност</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Какво е липсата на{" "}<span className="gradient-text">интимност?</span>
            </h2>
