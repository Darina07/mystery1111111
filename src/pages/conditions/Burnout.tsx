...
import { Phone, Battery, Brain, Heart, Target, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Бърнаут",
  subtitle: "Възстановяване от професионално изгаряне",
  ...
  whatIs: {
    ...
    content: "Бърнаут (професионално изгаряне) е състояние на хронично физическо и емоционално изтощение, причинено от продължителен стрес на работното място. Характеризира се с умора, цинизъм, намалена ефективност и чувство на безсмислие. Важно е да се адресира навреме, преди да доведе до сериозни здравословни последици."
  },
  howWeHelp: [
  ...
  benefits: ["Възстановена енергия и мотивация", "Баланс между работа и личен живот", "Яснота относно кариерните цели", "Превенция на бъдещо изгаряне", "Подобрено качество на живот"]
};
