...
const DEFAULT_IMAGE_BG = "https://darpsiholog.com/og-image.jpg";
const DEFAULT_IMAGE_EN = "https://darpsiholog.com/og-image-en.jpg";
...
export const SEO = ({
  ...
  const isEn = lang === "en";
  const resolvedImage = image ?? (isEn ? DEFAULT_IMAGE_EN : DEFAULT_IMAGE_BG);
