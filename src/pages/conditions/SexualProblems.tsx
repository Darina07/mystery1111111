...
const conditionData = {
  title: "Сексуални проблеми и смущения",
  subtitle: "Семейно консултиране",
  description: "Дискретна и професионална помощ при сексуални затруднения в партньорството.",
  ...
  whatIs: {
    title: "Какво са сексуалните проблеми?",
    content: `Сексуалните проблеми са често срещани и могат да засегнат всяка двойка в различни етапи от връзката. Те включват широк спектър от затруднения, свързани със сексуалното желание, възбуда, удовлетворение или болка.

Често срещани проблеми:
• Липса или намалено сексуално желание
• Различия в сексуалните нужди между партньорите
• Трудности с възбуда или оргазъм
• Болка или дискомфорт при сексуални контакти
• Сексуални затруднения след раждане или заболяване
  ...
  howWeHelp: [
    {
      ...
      description: "Предлагаме конфиденциално и неосъждащо пространство за разговор по чувствителни теми."
    },
    {
      icon: Heart,
      title: "Емоционална близост",
      description: "Работим върху връзката между емоционална и физическа интимност."
    },
    {
      icon: MessageCircle,
      title: "Открита комуникация",
      description: "Учим двойките да говорят за сексуалните си нужди и желания."
    },
    {
      icon: Users,
      title: "Практически подход",
      description: "Предлагаме конкретни техники и упражнения за подобряване на интимния живот."
    },
  ],
  benefits: [
    "По-добро разбиране на собствените нужди",
    "Подобрена комуникация за интимността",
    "Намаляване на тревожността",
    "По-удовлетворяващ сексуален живот",
    "По-силна емоционална връзка",
    "Повишена увереност",
  ],
};
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Сексуални проблеми и{" "}<span className="gradient-text">смущения</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Какво са сексуалните{" "}<span className="gradient-text">проблеми?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Дискретна и професионална подкрепа.</p>
            </div>
