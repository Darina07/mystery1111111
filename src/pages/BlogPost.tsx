  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg max-w-none prose-headings:font-playfair prose-h2:text-primary prose-h2:text-3xl prose-h2:md:text-4xl prose-h2:font-bold prose-h2:mt-20 prose-h2:mb-8 prose-h2:pt-8 prose-h2:border-t prose-h2:border-primary/20 prose-h3:text-primary prose-h3:text-xl prose-h3:md:text-2xl prose-h3:font-semibold prose-h3:mt-12 prose-h3:mb-6 prose-p:text-[#3B3A64] prose-p:mb-8 prose-p:leading-loose prose-p:text-lg prose-li:text-[#3B3A64] prose-li:mb-4 prose-li:text-lg prose-strong:text-[#221A42] prose-ul:my-8 prose-ul:pl-6 prose-ul:list-disc prose-blockquote:border-l-4 prose-blockquote:border-primary prose-blockquote:bg-primary/5 prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:italic prose-blockquote:my-10 prose-hr:my-14 prose-hr:border-primary/20 [&_ul]:list-disc [&_ul_li]:marker:text-primary [&_ul_li::marker]:text-xl [&>h2:first-of-type]:mt-8 [&>h2:first-of-type]:border-t-0 [&>h2:first-of-type]:pt-0">
