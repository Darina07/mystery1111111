...
import { Phone, Flame, Brain, Heart, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Гняв и автоагресия",
  subtitle: "Управление на гнева и самонараняващо поведение",
  ...
  whatIs: {
    ...
    content: "Гневът е нормална емоция, но когато става неконтролируем, може да навреди на взаимоотношенията и здравето. Автоагресията (самонараняване) е начин за справяне с емоционална болка, който изисква специализирана помощ. И двете състояния могат да бъдат успешно преодолени с правилния подход."
  },
  howWeHelp: [
    { icon: Flame, title: "Разпознаване на тригери", description: "Идентифициране на ситуациите, които предизвикват гнева." },
    { icon: Brain, title: "Когнитивни техники", description: "Промяна на мислите, които подхранват гнева." },
  ...
  benefits: ["Контрол върху емоционалните реакции", "По-здрави взаимоотношения", "Намалено напрежение", "Алтернативи на самонараняването", "По-висока самооценка"]
};
