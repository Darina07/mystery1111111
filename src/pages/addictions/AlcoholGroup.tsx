...
import { Phone, Calendar, Shield, Lock, Users, Heart, CheckCircle, Clock, MessageCircle } from "lucide-react";
...
const groupFeatures = [
  ...
  "Подкрепа в процеса на промяна",
];

const whoIsItFor = [
  "Хора, които изпитват затруднения в контролирането на употребата на алкохол",
  "Тези, които искат да намалят или спрат употребата",
  "Хора, търсещи подкрепа в процеса на възстановяване",
  "Всеки, който чувства, че алкохолът влияе негативно на живота му",
];

const whatToExpect = [
  {
    title: "Безопасно пространство",
    description: "Група от хора, които разбират през какво преминавате, без осъждане",
    icon: Heart,
  },
  {
    title: "Структурирани сесии",
    description: "Ясна програма с фокус върху конкретни теми и умения",
    icon: Clock,
  },
  {
    title: "Професионално водене",
    description: "Групата се води от специалист с опит в работата със зависимости",
    icon: Shield,
  },
  {
    title: "Конфиденциалност",
    description: "Всичко споделено в групата остава в групата",
    icon: Lock,
  },
];
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Алкохол</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Анонимна група за проблемна употреба на{" "}
              <span className="gradient-text">алкохол</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Проблемната употреба на алкохол може да засегне всеки – независимо от възраст, професия или социален статус. 
                Нашата анонимна група предлага безопасно пространство, където можете да споделите своя опит, 
                да получите подкрепа от хора, които разбират през какво преминавате, и да работите върху промяната, 
            ...
            <div className="mt-12 bg-primary/5 rounded-2xl p-8 border border-primary/10">
              ...
              <p className="text-center text-muted-foreground">
                Не се изискват лични данни. Не се записват имена. Не се разкрива информация. 
                Вашето участие остава напълно конфиденциално.
              </p>
            </div>
          </div>
        </div>
