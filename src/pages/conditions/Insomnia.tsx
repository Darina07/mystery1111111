...
import { Phone, Moon, Brain, Clock, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Безсъние",
  subtitle: "Възстановяване на здравословния сън",
  ...
  whatIs: {
    ...
    content: "Безсънието включва трудности при заспиване, чести събуждания през нощта или ранно събуждане с невъзможност за повторно заспиване. Хроничното безсъние влияе негативно на настроението, концентрацията, енергията и цялостното здраве. Когнитивно-поведенческата терапия за безсъние е доказано ефективен метод за лечение."
  },
  howWeHelp: [
    { icon: Moon, title: "Хигиена на съня", description: "Изграждане на здравословни навици за сън." },
    ...
    { icon: Shield, title: "Релаксационни техники", description: "Методи за успокояване преди сън." }
  ],
  benefits: ["По-бързо заспиване", "По-качествен и дълбок сън", "Събуждане освежени", "Подобрена дневна енергия", "Дългосрочно решение без медикаменти"]
};
