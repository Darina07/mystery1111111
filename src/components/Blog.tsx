...
import { blogPosts as allBlogPosts, getPostTitle, getPostExcerpt, getPostCategoryLabel, getPostDate } from "@/data/blogPosts";
      ...
      <div className="container">
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="uppercase text-white shadow-soft hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]" style={{ background: 'var(--gradient-cta)' }} asChild>
            <Link to={localized("/blog")}>{t("common.allArticles")}</Link>
          </Button>
        </div>
      </div>
    </section>
