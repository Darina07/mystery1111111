...
import { Phone, Shield, Lock, Users, Heart, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupGamblingHeader})` }}
        />
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <img 
                  src={groupGamblingWho} 
                  alt="Илюстрация за хазартна зависимост" 
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Анонимна група за хазартна зависимост" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
