...
const conditionData = {
  ...
  whatIs: {
    title: "Какво означава изневярата за връзката?",
    content: `Изневярата е една от най-болезнените преживявания в партньорската връзка. Тя разрушава доверието и създава дълбока емоционална рана както за предадения партньор, така и за този, който е изневерил.

Възстановяването е възможно, но изисква:
• Честност и пълно разкриване на истината
• Поемане на отговорност без оправдания
• Търпение и последователност в действията
• Готовност за дълбока емоционална работа
• Преосмисляне на отношенията и новото им изграждане`,
  },
  howWeHelp: [
    {
      icon: Shield,
      title: "Безопасно пространство",
      description: "Създаваме среда за изразяване на болка, гняв и объркване без осъждане."
    },
    {
      icon: Heart,
      title: "Работа с травмата",
      description: "Помагаме за преработване на емоционалната травма от изневярата."
    },
    {
      icon: MessageCircle,
      title: "Възстановяване на доверието",
      description: "Изграждаме стъпка по стъпка ново доверие между партньорите."
    },
    {
      icon: Users,
      title: "Ново начало",
      description: "Подкрепяме двойката в изграждането на по-здрави отношения."
    },
  ],
  benefits: [
    "Преработване на болката и гнева",
    "Разбиране на причините за изневярата",
    "Вземане на осъзнато решение за бъдещето",
    "Възстановяване на доверието (ако изберете да останете)",
    "По-силна и честна връзка",
    "Емоционално изцеление",
  ],
};
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Изневяра и възстановяване на{" "}<span className="gradient-text">връзката</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Какво означава изневярата за{" "}<span className="gradient-text">връзката?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Направете първата стъпка към изцеление.</p>
            </div>
