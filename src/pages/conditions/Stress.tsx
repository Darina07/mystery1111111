...
import { Phone, Gauge, Brain, Heart, Wind, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Стрес",
  subtitle: "Управление на стреса и напрежението",
  ...
  whatIs: {
    ...
    content: "Стресът е реакция на организма към предизвикателства и заплахи. Макар краткосрочният стрес да е нормален, хроничният стрес може да доведе до здравословни проблеми – от главоболие и безсъние до сърдечно-съдови заболявания. Научаването да управлявате стреса е ключово за здравето и благополучието."
  },
  howWeHelp: [
    { icon: Gauge, title: "Оценка на стреса", description: "Идентифициране на източниците и нивото на стрес." },
  ...
  benefits: ["Намалено напрежение и безпокойство", "По-добър сън", "Повишена продуктивност", "Подобрено физическо здраве", "Баланс между работа и личен живот"]
};
