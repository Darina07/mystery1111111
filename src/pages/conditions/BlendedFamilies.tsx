...
const conditionData = {
  ...
  whatIs: {
    title: "Какви са предизвикателствата при смесените семейства?",
    content: `Смесените семейства, в които партньорите имат деца от предишни връзки, се сблъскват с уникални предизвикателства. Изграждането на нова семейна идентичност изисква време, търпение и разбиране.

Чести предизвикателства:
• Адаптация на децата към новия партньор
• Определяне на роли и граници
• Ревност и конкуренция между децата
• Отношения с бившите партньори
• Различни стилове на възпитание
• Лоялност към биологичния родител
• Изграждане на нови семейни традиции`,
  },
  howWeHelp: [
    {
      icon: Users,
      title: "Семейна интеграция",
      description: "Подкрепяме постепенното изграждане на връзки между всички членове на семейството."
    },
    {
      icon: Shield,
      title: "Ясни роли и граници",
      description: "Помагаме за определяне на реалистични очаквания и граници."
    },
    {
      icon: MessageCircle,
      title: "Комуникация",
      description: "Подобряваме комуникацията между партньорите и с децата."
    },
    {
      icon: Heart,
      title: "Емоционална подкрепа",
      description: "Работим с емоциите на всички – деца и възрастни."
    },
  ],
  benefits: [
    "По-плавна адаптация за децата",
    "Ясни и уважавани роли в семейството",
    "По-добра комуникация между партньорите",
    "Здравословни отношения с бившите партньори",
    "Изграждане на нова семейна идентичност",
    "По-хармонична семейна атмосфера",
  ],
};

const BlendedFamilies = () => {
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Нови партньори и смесени{" "}<span className="gradient-text">семейства</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Какви са предизвикателствата при смесените{" "}<span className="gradient-text">семейства?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Изградете щастливо ново семейство.</p>
            </div>
