...
import { Phone, RefreshCw, Brain, Target, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "ОКР",
  subtitle: "Обсесивно-компулсивно разстройство",
  ...
  whatIs: {
    ...
    content: "Обсесивно-компулсивното разстройство се характеризира с натрапчиви мисли (обсесии) и повтарящи се действия (компулсии), извършвани за намаляване на тревожността. Това може да включва прекомерно миене на ръце, проверяване, подреждане или умствени ритуали. ОКР е лечимо състояние с правилния терапевтичен подход."
  },
  howWeHelp: [
  ...
  benefits: ["Намаляване на натрапчивите мисли", "Освобождаване от ритуалите", "По-малко време, прекарано в тревожност", "Възстановяване на нормалното функциониране", "Подобрено качество на живот"]
};
