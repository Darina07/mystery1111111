...
import { Phone, Eye, Target, Shield, Sparkles, Heart } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Фобии",
  subtitle: "Преодоляване на страховете и фобиите",
  ...
  whatIs: {
    ...
    content: "Фобията е интензивен, ирационален страх от конкретен обект, ситуация или дейност. Може да бъде страх от височини, затворени пространства, насекоми, социални ситуации и много други. Фобиите ограничават ежедневния живот и водят до избягващо поведение, но са едни от най-успешно лечимите тревожни разстройства."
  },
  howWeHelp: [
    { icon: Eye, title: "Експозиционна терапия", description: "Постепенно и безопасно излагане на страха." },
    { icon: Target, title: "Когнитивно преструктуриране", description: "Промяна на ирационалните убеждения." },
    { icon: Heart, title: "Релаксационни техники", description: "Управление на физиологичната реакция на страх." },
    { icon: Shield, title: "Изграждане на увереност", description: "Възстановяване на контрола над живота." }
  ],
  benefits: ["Свобода от ограничаващите страхове", "Способност да правите това, което желаете", "Намален стрес и тревожност", "По-пълноценен живот", "Увереност в предизвикателни ситуации"]
};
