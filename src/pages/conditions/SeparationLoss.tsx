...
const conditionData = {
  title: "Раздяла, загуба и житейски промени",
  subtitle: "Семейно консултиране",
  description: "Подкрепа при преминаване през раздяла, развод или други значими житейски промени.",
  ...
  whatIs: {
    title: "Как се справяме с раздялата?",
    content: `Раздялата и разводът са едни от най-стресиращите преживявания в живота. Те включват не само край на връзката, но и преосмисляне на идентичността, бъдещето и семейната динамика.

Предизвикателства при раздяла:
• Интензивни емоции – тъга, гняв, облекчение, вина
• Практически въпроси – имущество, финанси, жилище
• Грижа за децата и съвместно родителство
• Адаптация към новия живот
• Изграждане на нова идентичност
• Преосмисляне на бъдещето
• Отношения с общи приятели и семейство`,
  },
  howWeHelp: [
    {
      icon: Heart,
      title: "Емоционална подкрепа",
      description: "Помагаме за преработване на болката и емоциите от раздялата."
    },
    {
      icon: Users,
      title: "Съвместно родителство",
      description: "Подкрепяме изграждането на ефективно съвместно родителство след раздялата."
    },
    {
      icon: MessageCircle,
      title: "Комуникация с бившия партньор",
      description: "Учим конструктивна комуникация за доброто на децата."
    },
    {
      icon: Shield,
      title: "Ново начало",
      description: "Подкрепяме изграждането на нов живот и нова идентичност."
    },
  ],
  benefits: [
    "Преработване на емоциите от раздялата",
    "По-спокойни отношения с бившия партньор",
    "Ефективно съвместно родителство",
    "Минимизиране на въздействието върху децата",
    "Изграждане на нов живот",
    "Емоционално възстановяване",
  ],
};

const SeparationLoss = () => {
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Раздяла, загуба и житейски{" "}<span className="gradient-text">промени</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Как се справяме с{" "}<span className="gradient-text">раздялата?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Подкрепа в трудни моменти.</p>
            </div>
