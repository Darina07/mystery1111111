            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Вещества</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 bg-primary/5 rounded-2xl p-8 border border-primary/10">
              ...
              <p className="text-center text-muted-foreground">
                Не се изискват лични данни. Не се записват имена. Вашата идентичност остава защитена. 
                Всичко споделено в групата остава строго конфиденциално.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
              Първата стъпка е{" "}
              <span className="gradient-text">най-важната</span>
            </h2>
