  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg max-w-none prose-headings:font-playfair prose-h2:text-[#8F7BBF] prose-h2:text-4xl prose-h2:font-bold prose-h2:mt-16 prose-h2:mb-8 prose-h3:text-[#8F7BBF] prose-h3:text-2xl prose-h3:font-semibold prose-h3:mt-12 prose-h3:mb-6 prose-p:text-[#3B3A64] prose-p:mb-8 prose-p:leading-loose prose-p:text-lg prose-li:text-[#3B3A64] prose-li:mb-4 prose-li:text-lg prose-strong:text-[#221A42] prose-ul:my-8 prose-ul:pl-6 prose-ul:list-disc prose-blockquote:border-l-4 prose-blockquote:border-[#8F7BBF] prose-blockquote:bg-[#8F7BBF]/5 prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:italic prose-blockquote:my-10 prose-hr:my-12 [&_ul]:list-disc [&_ul_li]:marker:text-[#8F7BBF] [&_ul_li::marker]:text-xl">
