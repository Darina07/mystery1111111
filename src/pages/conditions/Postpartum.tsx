...
const conditionData = {
  ...
  whatIs: {
    title: "Как се променят отношенията след раждането?",
    content: `Раждането на дете е радостно, но и предизвикателно събитие, което трансформира връзката между партньорите. Много двойки се сблъскват с неочаквани трудности в този период.

Чести промени и предизвикателства:
• Преразпределяне на роли и отговорности
• Липса на сън и физическо изтощение
• Намалено време за двойката
• Промени в интимния живот
• Различни представи за родителството
• Чувство за изолация или неразбиране
  ...
  howWeHelp: [
    {
      ...
      description: "Помагаме за справяне с емоционалните предизвикателства на новото родителство."
    },
    {
      icon: Users,
      title: "Партньорска комуникация",
      description: "Подобряваме комуникацията и разбирането между партньорите."
    },
    {
      icon: MessageCircle,
      title: "Нови роли",
      description: "Подкрепяме адаптацията към ролите на родители, запазвайки партньорската връзка."
    },
    {
      icon: Shield,
      title: "Баланс и граници",
      description: "Помагаме за намиране на баланс между грижата за детето и грижата за връзката."
    },
  ],
  benefits: [
    "По-добро разбиране на промените",
    "Подобрена комуникация като родители",
    "Споделяне на отговорностите",
    "Запазване на партньорската близост",
    "Справяне със стреса и умората",
    "По-силна семейна връзка",
  ],
};
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Следродилен период и промени в{" "}<span className="gradient-text">отношенията</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Как се променят отношенията след{" "}<span className="gradient-text">раждането?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Подкрепа за вашето ново семейство.</p>
            </div>
