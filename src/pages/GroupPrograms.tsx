  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="групови програми психология, групова терапия София, групи за зависимости, групи за родители, НЛП групи, терапевтични групи"
      />
      <CourseSchema 
        ...
        url="https://darpsiholog.com/services/group-programs"
        courseMode="blended"
      />
