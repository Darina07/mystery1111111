  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="групи зависимости, алкохолна зависимост терапия, хазартна зависимост помощ, съзависимост, любовна зависимост, групова терапия зависимости София"
      />
      <CourseSchema 
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Групи за зависимости" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
