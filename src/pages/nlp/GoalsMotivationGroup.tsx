...
import { Phone, Target, Rocket, Sparkles, Users, CheckCircle, Mountain } from "lucide-react";
...
const groupFeatures = [
  ...
  "Преодоляване на вътрешни съпротиви",
  "Създаване на план за действие",
  "Работа с прокрастинация",
  "Изграждане на нови подкрепящи навици",
];

const whoIsItFor = [
  "Хора, които искат яснота за целите си",
  "Тези, които се борят с мотивацията",
  "Хора, готови за значима промяна в живота си",
  "Всеки, който иска да постигне повече",
];

const whatToExpect = [
  {
    title: "Ясни цели",
    description: "Научете как да формулирате цели, които наистина ви вдъхновяват",
    icon: Target,
  },
  {
    title: "Устойчива мотивация",
    description: "Техники за поддържане на огъня дори в трудни моменти",
    icon: Rocket,
  },
  {
    title: "Промяна в действие",
    description: "Конкретни стъпки за превръщане на мечтите в реалност",
    icon: Sparkles,
  },
  {
    title: "Групова енергия",
    description: "Подкрепа и вдъхновение от съмишленици",
    icon: Users,
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupNLPGoalsHeader})` }}
        />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Цели, мотивация и{" "}
              <span className="gradient-text">промяна</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              НЛП техники за постигане на желаните резултати
            </p>
      ...
      <div className="container py-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link to="/services/group-programs/nlp">НЛП</Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Цели и мотивация</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Много хора имат мечти, но малцина ги превръщат в реалност. 
                Разликата е в яснотата на целите и способността да поддържаш мотивацията. 
                В тази НЛП група ще научите как да поставяте цели, които наистина ви 
                вдъхновяват, и как да създадете устойчива промяна в живота си.
              </p>
            </div>
            ...
            <div className="mt-12 relative">
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                ...
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  С правилните инструменти и ясна посока, всяка цел е постижима. 
                  НЛП ви помага да преодолеете вътрешните бариери и да действате.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="НЛП програма – Цели, мотивация и промяна" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
