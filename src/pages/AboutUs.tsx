      ...
      <section className="relative pt-24 min-h-[600px] overflow-hidden">
        ...
        <div className="container relative z-10 h-full flex items-center justify-center min-h-[500px]">
          <div className="text-center space-y-6 max-w-3xl">
            <p className="text-white font-medium mb-4 [text-shadow:_0_2px_8px_rgba(0,0,0,0.8)]">За нас</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight text-white [text-shadow:_0_2px_12px_rgba(0,0,0,0.9)]">
              ...
              <span className="text-lavender">{heroSlides[currentSlide].highlight}</span>
            </h1>
