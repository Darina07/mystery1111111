  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="групи взаимоотношения, привързаност терапия, социални умения група, след раздяла подкрепа, matchmaking психология, емоционална готовност връзка"
      />
      <CourseSchema 
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Групи за взаимоотношения" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
