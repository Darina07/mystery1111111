...
import { Phone, Zap, RefreshCw, Sparkles, Users, CheckCircle, Repeat } from "lucide-react";
...
const groupFeatures = [
  ...
  "НЛП техники за промяна на навици",
  "Създаване на нови подкрепящи модели",
  "Работа с автоматични реакции",
  "Изграждане на устойчиви промени",
];

const whoIsItFor = [
  "Хора, които искат да променят нежелани навици",
  "Тези, които се борят с повтарящи се модели",
  "Хора, готови за осъзната трансформация",
  "Всеки, който иска да изгради нови, по-добри навици",
];

const whatToExpect = [
  {
    title: "Разбиране на навиците",
    description: "Как работят автоматичните поведения и защо ги повтаряме",
    icon: Repeat,
  },
  {
    title: "Прекъсване на модели",
    description: "Техники за спиране на нежелани автоматични реакции",
    icon: Zap,
  },
  {
    title: "Нови модели",
    description: "Създаване и закрепване на подкрепящи поведения",
    icon: RefreshCw,
  },
  {
    title: "Групова подкрепа",
    description: "Взаимна подкрепа в процеса на промяна",
    icon: Users,
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupNLPHabitsHeader})` }}
        />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Навици и поведение</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Навици и{" "}
              <span className="gradient-text">поведение</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              НЛП техники за трансформиране на поведенчески модели
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Навиците ни формират живота. Те могат да бъдат наши съюзници или врагове. 
                В тази НЛП група ще научите как работят автоматичните поведения, 
                как да прекъснете нежеланите модели и как да изградите нови навици, 
                които ви подкрепят в постигането на целите ви.
              </p>
            </div>
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl md:text-2xl font-heading font-semibold uppercase tracking-wide text-primary-foreground">
                    Станете архитект на поведението си
                  </h3>
                </div>
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  НЛП ви дава инструментите да разберете и промените 
                  автоматичните модели, които управляват ежедневието ви.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="НЛП програма – Навици и поведение" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
