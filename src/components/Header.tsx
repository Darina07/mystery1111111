                          ...
                          <li key={subItem.label} className="relative group/sub">
                            {subItem.hasSubmenu ? (
                              <div className="relative">
                                ...
                                <ul className="absolute left-full top-0 ml-1 w-[280px] bg-white rounded-lg shadow-lg p-3 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all z-50">
