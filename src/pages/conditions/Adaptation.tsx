...
import { Phone, Compass, Shield, Target, Sunrise, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Адаптация към промени",
  subtitle: "Подкрепа при житейски преходи",
  ...
  whatIs: {
    ...
    content: "Промените в живота – било то преместване, нова работа, пенсиониране, промяна в здравето или семейния статус – изискват период на адаптация. Дори положителните промени могат да предизвикат стрес и несигурност. Адаптацията е процес на приспособяване към новата реалност, който изисква гъвкавост, търпение и подкрепа."
  },
  howWeHelp: [
    {
      icon: Compass,
      title: "Ориентация в промяната",
      description: "Помощ за разбиране на новата ситуация и нейните предизвикателства."
    },
    {
      icon: Shield,
      title: "Емоционална устойчивост",
      description: "Развиване на способност за справяне с несигурността."
    },
    {
      icon: Target,
      title: "Практически стратегии",
      description: "Конкретни стъпки за успешна адаптация."
    },
    {
      icon: Sunrise,
      title: "Откриване на възможности",
      description: "Намиране на положителните аспекти в новата ситуация."
    }
  ],
  benefits: [
