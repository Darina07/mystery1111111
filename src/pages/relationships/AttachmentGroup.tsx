...
import { Phone, Heart, Shield, Users, CheckCircle, Target } from "lucide-react";
...
const groupFeatures = [
  ...
  "Анализ на миналите ви взаимоотношения",
  "Разпознаване на нездравословни модели",
  "Работа върху страхове от близост",
  "Практически упражнения за промяна",
  "Групова подкрепа и обратна връзка",
];

const whoIsItFor = [
  "Хора, които многократно попадат в нездравословни връзки",
  "Тези, които се чувстват привлечени от 'грешния тип' партньори",
  "Хора с трудности в изграждането на дълготрайни връзки",
  "Всеки, който иска да разбере защо връзките му не успяват",
];

const whatToExpect = [
  {
    title: "Самопознание",
    description: "Разберете своя стил на привързаност и как той влияе на изборите ви",
    icon: Heart,
  },
  {
    title: "Групова динамика",
    description: "Учете се от опита на другите в сходна ситуация",
    icon: Users,
  },
  {
    title: "Практически инструменти",
    description: "Конкретни техники за разпознаване на здрави партньори",
    icon: Target,
  },
  {
    title: "Професионално водене",
    description: "Групата се води от специалист по взаимоотношения",
    icon: Shield,
  },
];
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Модели на привързаност и{" "}
              <span className="gradient-text">избор на партньор</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Разберете защо избирате определени партньори и как да промените модела
            </p>
      ...
      <div className="container py-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Модели на привързаност</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Начинът, по който сме се привързвали към родителите си в детството, оформя модела, 
                по който избираме партньори и се свързваме с тях като възрастни. Тази група ви помага 
                да разберете своя стил на привързаност, да разпознаете повтарящите се модели във 
                взаимоотношенията си и да започнете осъзнато да избирате партньори, с които можете 
                да изградите здрава връзка.
              </p>
            </div>
            ...
            <div className="mt-12 relative">
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                ...
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  Когато разберете защо избирате определени партньори, можете да промените модела 
                  и да започнете да изграждате връзки, базирани на здрави основи.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група – Модели на привързаност и избор на партньор" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
