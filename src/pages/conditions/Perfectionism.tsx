...
import { Phone, Target, Brain, Heart, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Перфекционизъм",
  subtitle: "Освобождаване от капана на перфекционизма",
  ...
  whatIs: {
    ...
    content: "Перфекционизмът е стремеж към безупречност, придружен от прекомерна самокритика. Въпреки че може да мотивира, той често води до тревожност, прокрастинация, страх от провал и изтощение. Здравословният стремеж към високи постижения е различен от разрушителния перфекционизъм."
  },
  howWeHelp: [
    { icon: Target, title: "Реалистични стандарти", description: "Научаване да поставяте постижими цели." },
    { icon: Brain, title: "Работа с вътрешния критик", description: "Смекчаване на самокритичния вътрешен глас." },
    { icon: Heart, title: "Самосъстрадание", description: "Развиване на по-мека нагласа към себе си." },
    { icon: Shield, title: "Приемане на несъвършенството", description: "Научаване да живеете с грешки и ограничения." }
  ],
  benefits: ["По-малко стрес и тревожност", "По-висока продуктивност", "Способност да завършвате проекти", "По-добри взаимоотношения", "Баланс между амбиция и благополучие"]
};
