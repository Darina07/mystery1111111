...
import { Phone, Users, Heart, MessageCircle, Target, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Самота",
  subtitle: "Преодоляване на самотата и изолацията",
  ...
  whatIs: {
    ...
    content: "Самотата е субективно усещане за липса на значими социални връзки. Тя може да се изпитва дори сред много хора. Хроничната самота влияе на психичното и физическото здраве, но е състояние, което може да бъде променено с правилния подход и подкрепа."
  },
  howWeHelp: [
    { icon: Users, title: "Разбиране на самотата", description: "Изследване на причините и моделите, които поддържат изолацията." },
    { icon: MessageCircle, title: "Социални умения", description: "Развиване на увереност в социални ситуации." },
    { icon: Heart, title: "Качество на връзките", description: "Фокус върху дълбочината, а не количеството на взаимоотношенията." },
    { icon: Target, title: "Практически стъпки", description: "Изграждане на нови връзки и общности." }
  ],
  benefits: ["Чувство за принадлежност", "По-дълбоки взаимоотношения", "Увереност в социални ситуации", "Намалена изолация", "По-богат социален живот"]
};
