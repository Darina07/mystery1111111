...
import { Phone, MessageCircle, Users, Heart, Target, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Трудности в общуването",
  subtitle: "Подкрепа при социални затруднения",
  ...
  whatIs: {
    ...
    content: "Трудностите в общуването могат да се проявят като затруднения при започване на разговор, поддържане на контакт, изразяване на мнение или емоции, страх от социални ситуации или конфликти. Те могат да засегнат личните отношения, професионалния живот и цялостното благополучие."
  },
  howWeHelp: [
    {
      icon: MessageCircle,
      title: "Комуникационни умения",
      description: "Развиване на ефективни техники за водене на разговор и изразяване на мисли."
    },
    {
      icon: Users,
      title: "Социални умения",
      description: "Изграждане на увереност в социални ситуации и групови взаимодействия."
    },
    {
      icon: Heart,
      title: "Емоционална интелигентност",
      description: "Разпознаване и управление на емоциите в общуването."
    },
    {
      icon: Target,
      title: "Асертивност",
      description: "Научаване да изразявате нуждите си уважително и ефективно."
    }
  ],
  benefits: [
...
const CommunicationDifficulties = () => {
  return (
