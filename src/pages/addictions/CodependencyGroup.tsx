...
import { Phone, Shield, Lock, Users, Heart, CheckCircle, HandHeart } from "lucide-react";
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група за близки на хора със зависимости (съзависимост)" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
