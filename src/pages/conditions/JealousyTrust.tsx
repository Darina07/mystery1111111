...
const conditionData = {
  ...
  whatIs: {
    title: "Какво е ревността във връзката?",
    content: `Ревността е сложна емоция, която може да варира от лека несигурност до интензивен страх от загуба на партньора. Когато ревността стане прекомерна, тя може да разруши доверието и да навреди на отношенията.

Как се проявява проблемната ревност:
• Постоянна нужда от потвърждение и успокоение
• Контролиращо поведение и проверки
• Обвинения без основание
• Ограничаване на социалните контакти на партньора
• Интензивна тревожност при раздяла`,
  },
  howWeHelp: [
    {
      icon: Shield,
      title: "Работа с несигурността",
      description: "Изследваме корените на несигурността и помагаме за изграждане на вътрешна стабилност."
    },
    {
      icon: Heart,
      title: "Изграждане на доверие",
      description: "Работим върху възстановяване и укрепване на доверието между партньорите."
    },
    {
      icon: MessageCircle,
      title: "Подобряване на комуникацията",
      description: "Учим двойките да споделят страховете си без обвинения и защитни реакции."
    },
    {
      icon: Users,
      title: "Здравословни граници",
      description: "Помагаме за установяване на баланс между близост и лично пространство."
    },
  ],
  benefits: [
    "Намаляване на тревожността и страха",
    "По-голямо доверие в партньора",
    "Освобождаване от контролиращо поведение",
    "По-спокойни и сигурни отношения",
    "Подобрена самооценка",
    "Емоционална свобода и лекота",
  ],
};
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Ревност и липса на{" "}<span className="gradient-text">доверие</span>
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-8 text-center">
              Какво е ревността във{" "}<span className="gradient-text">връзката?</span>
            </h2>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Направете първата стъпка към по-здрава и щастлива връзка.</p>
            </div>
