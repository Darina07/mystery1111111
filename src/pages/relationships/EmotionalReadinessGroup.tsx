...
import { Phone, Heart, Sparkles, Shield, Users, CheckCircle, Brain } from "lucide-react";
...
const groupFeatures = [
  ...
  "Преодоляване на страхове от интимност",
  "Изграждане на вътрешна сигурност",
  "Баланс между независимост и близост",
  "Практики за емоционална саморегулация",
];

const whoIsItFor = [
  "Хора, които се чувстват неготови за сериозна връзка",
  "Тези, които избягват близостта или се страхуват от нея",
  "Хора след дълъг период на самота",
  "Всеки, който иска да работи върху емоционалната си зрялост",
];

const whatToExpect = [
  {
    title: "Емоционална зрялост",
    description: "Развийте способността си да управлявате емоциите в контекста на връзка",
    icon: Brain,
  },
  {
    title: "Самопознание",
    description: "Разберете какво наистина искате и какво можете да дадете във връзка",
    icon: Heart,
  },
  {
    title: "Вътрешна сигурност",
    description: "Изградете увереност, която не зависи от външно потвърждение",
    icon: Shield,
  },
  {
    title: "Групова подкрепа",
    description: "Споделяйте пътя с хора, които се стремят към същото",
    icon: Users,
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupEmotionalReadinessHeader})` }}
        />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Емоционална готовност</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Емоционална готовност за{" "}
              <span className="gradient-text">връзка</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Подготовка за здрава връзка чрез работа върху емоционална зрялост и самопознание
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Истинската готовност за връзка не е просто желание да имаш партньор – 
                това е способността да бъдеш емоционално наличен, да даваш и получаваш любов, 
                и да поддържаш здравословна връзка. Тази група ви помага да развиете емоционалната 
                зрялост и вътрешната сигурност, които са основата на всяка здрава връзка.
              </p>
            </div>
            ...
            <div className="mt-12 relative">
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                ...
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  Най-добрата подготовка за здрава връзка е работата върху себе си – 
                  да станете човекът, който може да изгради и поддържа любовта.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <img 
                  src={groupEmotionalReadinessBg} 
                  alt="Емоционална готовност за връзка" 
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група – Емоционална готовност за връзка" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
