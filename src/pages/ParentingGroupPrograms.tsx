...
const parentingGroups = [
  {
    title: "Група за бременни и бъдещи майки",
    description: "Емоционална подкрепа през бременността. Споделяне на преживявания, страхове и радости с други бъдещи майки.",
    link: "/services/group-programs/parenting/pregnant-mothers",
    icon: Heart,
    image: groupPregnantMothersBg,
  },
  {
    title: "Следродилен период – адаптация и подкрепа",
    description: "Подкрепа за справяне с тревожност, адаптация към новата роля и емоционалните предизвикателства след раждането.",
    link: "/services/group-programs/parenting/postpartum",
    icon: Baby,
    image: groupPostpartumBg,
  },
  {
    title: "Родители на малки деца",
    description: "Група за родители на деца от 0 до 6 години. Емоции, граници, сигурност и ежедневни предизвикателства.",
    link: "/services/group-programs/parenting/toddler-parents",
    icon: Users,
    image: groupToddlerParentsBg,
  },
  {
    title: "Родители в трудни житейски ситуации",
    description: "Подкрепяща група за родители, преминаващи през развод, загуба, болест или други трудни житейски обстоятелства.",
    link: "/services/group-programs/parenting/difficult-situations",
    icon: Shield,
    image: groupDifficultSituationsBg,
  },
];
...
const keyPoints = [
  {
    title: "Не сте сами",
    description: "Споделете преживяванията си с други родители, които разбират през какво преминавате",
    icon: Heart,
  },
  {
    title: "Спокойствие и сигурност",
    description: "Безопасно пространство, където можете да бъдете себе си без осъждане",
    icon: Shield,
  },
  {
    title: "Професионална подкрепа",
    description: "Групите се водят от квалифицирани специалисти с опит в работата с родители",
    icon: Sparkles,
  },
  {
    title: "Общност от разбиране",
    description: "Изградете връзки с други родители и намерете подкрепа в ежедневието",
    icon: Users,
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="групи за родители, бременност подкрепа, следродилна депресия група, родители малки деца, родителска подкрепа София"
      />
      <CourseSchema 
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              Създаваме топло, подкрепящо пространство, където родителството 
              се преживява заедно.
            </p>
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
              ...
              <p className="text-primary-foreground/80 max-w-2xl mx-auto text-center">
                Родителството е красиво пътуване, но понякога е и предизвикателно. 
                Тук ще намерите разбиране, подкрепа и общност от хора, 
                които преминават през същото.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Родителски групи" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
