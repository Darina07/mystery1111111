...
import { Phone, Stethoscope, Brain, Heart, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Хипохондрия",
  subtitle: "Освобождаване от здравната тревожност",
  ...
  whatIs: {
    ...
    content: "Хипохондрията (здравна тревожност) е състояние, при което човек е прекомерно загрижен, че има или ще развие сериозно заболяване. Нормалните телесни усещания се интерпретират като симптоми на болест, водещи до постоянна тревожност, чести посещения при лекари и търсене на успокоение."
  },
  howWeHelp: [
    { icon: Stethoscope, title: "Разбиране на симптомите", description: "Научаване да разпознавате разликата между тревожност и болест." },
  ...
  benefits: ["Освобождаване от постоянната загриженост", "По-малко посещения при лекари", "Доверие в собственото тяло", "По-спокоен ум", "Качествен живот без страх от болести"]
};
