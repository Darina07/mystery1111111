...
import { Phone, Zap, Heart, Wind, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Паник атаки",
  subtitle: "Ефективна помощ при панически разстройства",
  ...
  whatIs: {
    ...
    content: "Паническата атака е внезапен епизод на интензивен страх, придружен от физически симптоми като учестено сърцебиене, задъхване, треперене, изпотяване и усещане за загуба на контрол. Въпреки че са плашещи, паническите атаки не са опасни и могат да бъдат успешно лекувани."
  },
  howWeHelp: [
    { icon: Zap, title: "Разбиране на симптомите", description: "Научаване какво се случва в тялото по време на атака." },
    { icon: Wind, title: "Дихателни техники", description: "Овладяване на дишането за бързо успокояване." },
    { icon: Heart, title: "Когнитивна преработка", description: "Промяна на катастрофичните мисли." },
    { icon: Shield, title: "Превенция", description: "Стратегии за намаляване честотата на атаките." }
  ],
  benefits: ["Контрол върху паническите симптоми", "Намаляване честотата на атаките", "Освобождаване от страха от паника", "Увереност в публични ситуации", "По-спокоен ежедневен живот"]
};
