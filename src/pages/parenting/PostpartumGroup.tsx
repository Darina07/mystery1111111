...
import { Phone, Heart, Users, Shield, Sparkles, CheckCircle, Baby } from "lucide-react";
...
const groupFeatures = [
  ...
  "Адаптация към новата роля на майка",
  "Техники за грижа за себе си като нова майка",
  "Изграждане на връзка с бебето",
  "Подкрепа от жени, които разбират",
];

const whoIsItFor = [
  "Жени в първите месеци след раждането",
  "Майки, които изпитват тревожност или потиснатост",
  "Жени, които се чувстват самотни в новата си роля",
  "Майки, които търсят разбиране и подкрепа",
];

const whatToExpect = [
  {
    title: "Разбиране без осъждане",
    description: "Пространство, където е нормално да споделите трудностите",
    icon: Heart,
  },
  {
    title: "Емоционална подкрепа",
    description: "Помощ за справяне с тревожност и емоционални трудности",
    icon: Shield,
  },
  {
    title: "Връзка с бебето",
    description: "Техники за укрепване на връзката майка-бебе",
    icon: Baby,
  },
  {
    title: "Общност от майки",
    description: "Връзки с жени, които преминават през същото",
    icon: Users,
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupPostpartumHeader})` }}
        />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Следродилен период</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Следродилен{" "}
              <span className="gradient-text">период</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Адаптация, тревожност и подкрепа след раждането
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Следродилният период е време на голяма промяна. Физически и емоционално 
                се адаптирате към новата си роля, докато се грижите за бебе. Понякога 
                радостта се смесва с умора, тревожност или самота. Тази група е 
                безопасно място, където можете да споделите всичко и да намерите 
                подкрепа от жени, които разбират.
              </p>
            </div>
            ...
            <div className="mt-12 relative">
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                ...
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  Много майки изпитват подобни чувства. Важно е да знаете, 
                  че има помощ и подкрепа, когато имате нужда.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <img 
                  src={groupPostpartumBg} 
                  alt="Следродилен период" 
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група за следродилен период" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
