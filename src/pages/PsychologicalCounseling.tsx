          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="relative flex items-center justify-center overflow-hidden">
              <img 
                src={lgbtSticker1} 
                alt="ЛГБТ+ подкрепа" 
                className="max-w-[200px] md:max-w-[400px] md:-mr-16"
              />
              <img 
                src={lgbtSticker2} 
                alt="ЛГБТ+ подкрепа" 
                className="max-w-[100px] md:max-w-[200px] md:-ml-16"
              />
            </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Психологично консултиране" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
