...
import { Phone, Zap, Brain, Heart, Sun, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Умора",
  subtitle: "Преодоляване на хроничната умора",
  ...
  whatIs: {
    ...
    content: "Хроничната умора е постоянно чувство на изтощение, което не се облекчава от почивка. Тя може да има физически, емоционални или психологични причини. Често е свързана със стрес, депресия, тревожност или нездравословен начин на живот. Разбирането на основната причина е ключово за възстановяването."
  },
  howWeHelp: [
  ...
  benefits: ["Възстановена енергия и жизненост", "По-добър сън", "Яснота относно причините за умората", "Устойчиви навици за енергия", "Подобрено качество на живот"]
};
