...
const conditionData = {
  title: "Брачни трудности и кризи",
  subtitle: "Семейно консултиране",
  description: "Професионална подкрепа за двойки, преминаващи през трудни периоди в брака.",
  ...
  whatIs: {
    title: "Какво представляват брачните кризи?",
    content: `Брачните кризи са периоди на интензивно напрежение и несигурност в отношенията между съпрузите. Те могат да бъдат предизвикани от различни фактори – натрупани конфликти, промени в живота, загуба на връзка или външни обстоятелства.

Признаци на брачна криза:
• Чувство за отдалечаване и емоционална дистанция
• Загуба на интерес към партньора
• Чести спорове или пълно избягване на комуникация
• Усещане за безнадеждност относно бъдещето на брака
• Мисли за раздяла или развод`,
  },
  howWeHelp: [
    {
      icon: MessageCircle,
      title: "Възстановяване на диалога",
      description: "Създаваме безопасно пространство за открит и честен разговор между партньорите."
    },
    {
      icon: Heart,
      title: "Преоткриване на връзката",
      description: "Помагаме да си припомните какво ви е събрало и да намерите нов смисъл в отношенията."
    },
    {
      icon: Shield,
      title: "Разрешаване на конфликти",
      description: "Работим върху натрупани обиди и неразрешени проблеми от миналото."
    },
    {
      icon: Users,
      title: "Вземане на решения",
      description: "Подкрепяме ви при вземането на важни решения за бъдещето на връзката."
    },
  ],
  benefits: [
    "Ясна картина за състоянието на брака",
    "Подобрена комуникация между партньорите",
    "Разрешаване на стари конфликти",
    "Възстановяване на емоционалната близост",
    "Осъзнат избор за бъдещето",
    "По-силна и устойчива връзка",
  ],
};
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Брачни трудности и{" "}
              <span className="gradient-text">кризи</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/contact">
                <Button variant="hero" size="lg">КОНТАКТИ</Button>
              </Link>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-4">
              Как{" "}<span className="text-primary">помагаме?</span>
            </h2>
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-4">
              Какво ще{" "}<span className="gradient-text">постигнете?</span>
            </h2>
