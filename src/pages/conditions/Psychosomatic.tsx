...
const conditionData = {
  title: "Психосоматика",
  subtitle: "Връзката между ума и тялото",
  ...
  whatIs: {
    ...
    content: "Психосоматичните симптоми са физически оплаквания (болка, умора, храносмилателни проблеми), които са свързани с емоционални фактори. Стресът, тревожността и потиснатите емоции могат да се проявят в тялото. Разбирането на тази връзка е ключово за пълноценното възстановяване."
  },
  howWeHelp: [
  ...
  benefits: ["Облекчаване на физическите симптоми", "По-добро разбиране на тялото", "Ефективно управление на стреса", "Подобрено цялостно здраве", "Предотвратяване на хронични проблеми"]
};
