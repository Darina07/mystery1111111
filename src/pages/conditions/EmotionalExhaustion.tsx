...
import { Phone, BatteryLow, Heart, Sun, Shield, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Емоционално изчерпване",
  subtitle: "Възстановяване на емоционалните ресурси",
  ...
  whatIs: {
    ...
    content: "Емоционалното изчерпване е състояние на дълбока умора, при което се чувствате емоционално изтощени и неспособни да се справяте с ежедневните предизвикателства. То може да е резултат от продължителен стрес, грижа за други, травматични преживявания или липса на емоционална подкрепа."
  },
  howWeHelp: [
    { icon: BatteryLow, title: "Оценка на състоянието", description: "Разбиране на причините за изчерпването." },
  ...
  benefits: ["Възстановена емоционална енергия", "По-добро разбиране на собствените нужди", "Умения за предотвратяване на изчерпване", "По-балансиран начин на живот", "Подобрени взаимоотношения"]
};

const EmotionalExhaustion = () => {
  return (
