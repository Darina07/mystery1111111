...
import { Phone, MessageCircle, Shield, Smile, CheckCircle, Star } from "lucide-react";
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група – Социални умения и увереност" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
