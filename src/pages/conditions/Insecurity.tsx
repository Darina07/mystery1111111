...
import { Phone, Star, Brain, Heart, Target, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "Неувереност",
  subtitle: "Изграждане на самоувереност и самооценка",
  ...
  whatIs: {
    ...
    content: "Неувереността е съмнение в собствените способности, стойност и решения. Тя може да се прояви като страх от провал, избягване на предизвикателства, трудност при вземане на решения и зависимост от одобрението на другите. Работата върху себеоценката може да доведе до значителна промяна в качеството на живот."
  },
  howWeHelp: [
    { icon: Star, title: "Разбиране на корените", description: "Изследване на произхода на неувереността." },
    ...
    { icon: Target, title: "Практически стъпки", description: "Изграждане на увереност чрез действие." }
  ],
  benefits: ["По-висока самооценка", "Увереност в решенията", "Смелост да преследвате целите си", "По-автентични взаимоотношения", "Вътрешна сигурност и спокойствие"]
};
