...
const groupFeatures = [
  ...
  "Разбиране на детските емоции и поведение",
  "Техники за спокойно родителство",
  "Грижа за себе си като родител",
  "Споделяне на опит с други родители",
];

const whoIsItFor = [
  "Родители на деца от 0 до 6 години",
  "Родители, които търсят подкрепа в ежедневието",
  "Майки и татковци, които искат да разберат детето си по-добре",
  "Родители, които се чувстват уморени или претоварени",
];

const whatToExpect = [
  {
    title: "Практически съвети",
    description: "Конкретни техники за справяне с ежедневни ситуации",
    icon: Sparkles,
  },
  {
    title: "Емоционална подкрепа",
    description: "Пространство за споделяне на трудностите без осъждане",
    icon: Heart,
  },
  {
    title: "Здравословни граници",
    description: "Как да поставяме граници с любов и последователност",
    icon: Shield,
  },
  {
    title: "Родителска общност",
    description: "Връзки с други родители на малки деца",
    icon: Users,
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${groupToddlerParentsHeader})` }}
        />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Родители на малки деца</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Родители на{" "}
              <span className="gradient-text">малки деца</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Емоции, граници и сигурност в ранното детство
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Отглеждането на малки деца е пълно с радости, но и с предизвикателства. 
                Капризи, безсънни нощи, въпроси без отговори... В тази група ще намерите 
                разбиране, практически съвети и подкрепа от родители, които преминават 
                през същото. Защото не трябва да се справяте сами.
              </p>
            </div>
            ...
            <div className="mt-12 relative">
              ...
              <div className="bg-foreground/90 rounded-[10rem] p-8 md:p-10">
                ...
                <p className="text-center text-primary-foreground/90 max-w-2xl mx-auto">
                  Няма перфектни родители, но има родители, които се подкрепят взаимно. 
                  Елате да споделим пътуването.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-lg shadow-lg p-8 md:p-10">
              <ContactForm serviceName="Група за родители на малки деца" buttonVariant="hero" />
            </div>
          </div>
        </div>
      </section>
