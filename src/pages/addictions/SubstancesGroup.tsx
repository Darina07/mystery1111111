...
const groupFeatures = [
  ...
  "Работа върху механизмите на зависимостта",
  "Подкрепа в процеса на възстановяване",
];

const whoIsItFor = [
  "Хора, които се борят със зависимост към различни вещества",
  "Тези, които са в процес на възстановяване и търсят подкрепа",
  "Хора, които искат да разберат по-добре своята зависимост",
  "Всеки, който търси безопасно място за споделяне и промяна",
];

const whatToExpect = [
  {
    title: "Разбиране без осъждане",
    description: "Група от хора, които познават борбата и няма да ви съдят",
    icon: Heart,
  },
  {
    title: "Структурирана програма",
    description: "Ясен план за работа върху конкретни аспекти на възстановяването",
    icon: Clock,
  },
  {
    title: "Професионална подкрепа",
    description: "Водене от специалист с опит в работата със зависимости",
    icon: Shield,
  },
  {
    title: "Абсолютна поверителност",
    description: "Всичко споделено остава строго конфиденциално",
    icon: Lock,
  },
];
...
const SubstancesGroup = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Анонимна група за зависимости към вещества | ДАР Психология"
        description="Терапевтична група за хора, преживяващи зависимост към различни вещества"
        url="/services/group-programs/addictions/substances"
      />
      <CourseSchema 
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Вещества", url: "/services/group-programs/addictions/substances" }
      ]} />
      <Header />
        ...
        <div className="container relative z-10 pt-32 pb-20 min-h-[60vh] flex items-center justify-center">
          <div className="max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
              Анонимна група за зависимости към{" "}
              <span className="gradient-text">вещества</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Терапевтична група за подкрепа и възстановяване в безопасна среда
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Зависимостта към вещества е сложно предизвикателство, което изисква разбиране, подкрепа и професионална помощ. 
                Нашата анонимна група предлага безопасно пространство, където можете да споделите своя опит без страх от осъждане, 
                да се свържете с хора, които разбират вашата борба, и да получите подкрепа в пътя към възстановяването.
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <img 
                  src={groupSubstancesWho} 
                  alt="Илюстрация за зависимост към вещества" 
