...
import { Phone, Shield, Brain, Heart, Eye, Sparkles } from "lucide-react";
import { PageBreadcrumb } from "@/components/PageBreadcrumb";
import conditionsHeader from "@/assets/conditions-support.jpg";

const conditionData = {
  title: "ПТСР",
  subtitle: "Посттравматично стресово разстройство",
  ...
  whatIs: {
    ...
    content: "Посттравматичното стресово разстройство може да се развие след преживяване на травматично събитие – насилие, катастрофа, загуба или друго. Симптомите включват натрапчиви спомени, кошмари, избягване на напомнящи места, свръхбдителност и емоционално вцепенение. С правилната терапия възстановяването е възможно."
  },
  howWeHelp: [
  ...
  benefits: ["Намаляване на натрапчивите спомени", "По-добър сън без кошмари", "Възстановяване на чувството за безопасност", "Способност да живеете в настоящето", "Изграждане на нова перспектива"]
};
