...
import { Phone, Calendar, Heart, Sunrise, Shield, Users, CheckCircle, Sparkles } from "lucide-react";
            ...
            <div className="flex justify-center mb-6">
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbPage>След раздяла</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
